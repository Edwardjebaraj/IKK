...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget sendButton = Positioned(
      ...
      child: InkWell(
        onTap: () {
          // Amplify.Auth.resetPassword(username: phoneNumber.text)
          //     .then((value) => {
          //           Navigator.of(context).push(MaterialPageRoute(
          //               builder: (_) => ConfirmOtpPage(sendOtp: sendOtp)))
          //         })
          //     .catchError(((onError) =>
          //         {showAlertDialog(context, "Error", onError.message)}));
        },
    ...
    Widget resendAgainText = Padding(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            InkWell(
              onTap: () {
                // Amplify.Auth.resetPassword(username: phoneNumber.text).then(
                //     (value) =>
                //         showAlertDialog(context, "Success", 'Sent OTP again'));
